...
// https://github.com/vespaiach/axios-fetch-adapter/blob/main/LICENSE
// 09/14/23: Updated import paths
...
import browser from "axios/unsafe/platform/browser";
...
function createRequest(config) {
  ...
  if (method !== 'GET' && method !== 'HEAD') {
    ...
    if (utils.isFormData(options.body) && browser.isStandardBrowserEnv()) {
